"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：Code/LLRC/.venv/Lib/site-packages/pip/_internal/req/req_dependency_group.py
创建时间: 2025-08-22 11:55
创建人: 张宇成
更新记录:
- 2025-08-22 12:25 by 张宇成
- 2025-09-03 11:59 by 苏杰
LLRC Header End
"""
...
def _build_resolvers(paths: Iterable[str]) -> dict[str, Any]:
    """函数 _build_resolvers：处理 paths 相关逻辑。"""
    resolvers = {}
    for path in paths:
