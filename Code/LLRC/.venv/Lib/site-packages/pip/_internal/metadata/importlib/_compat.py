"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：Code/LLRC/.venv/Lib/site-packages/pip/_internal/metadata/importlib/_compat.py
创建时间: 2025-08-19 12:45
创建人: 苏杰
更新记录:
- 2025-08-19 13:15 by 谢佳悦
- 2025-08-27 12:45 by 张宇成
- 2025-09-02 16:43 by 潘显雨
LLRC Header End
"""
...
class BadMetadata(ValueError):
    """类 BadMetadata：封装与该模块相关的数据与行为。"""
    def __init__(self, dist: importlib.metadata.Distribution, *, reason: str) -> None:
        """函数 __init__：处理 dist, reason 相关逻辑。"""
        self.dist = dist
        self.reason = reason
