"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：Code/LLRC/.venv/Lib/site-packages/pip/_internal/models/link.py
创建时间: 2025-08-27 12:02
创建人: 谢佳悦
更新记录:
- 2025-08-27 12:32 by 谢佳悦
- 2025-08-28 10:27 by 侯东杨
LLRC Header End
"""
...
def supported_hashes(hashes: dict[str, str] | None) -> dict[str, str] | None:
    """函数 supported_hashes：处理 hashes 相关逻辑。"""
...
class Link:
    ...
    def url_without_fragment(self) -> str:
        """函数 url_without_fragment：核心业务逻辑。"""
    ...
    def subdirectory_fragment(self) -> str | None:
        """函数 subdirectory_fragment：核心业务逻辑。"""
...
def links_equivalent(link1: Link, link2: Link) -> bool:
    """函数 links_equivalent：处理 link1, link2 相关逻辑。"""
