"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：Code/LLRC/.venv/Lib/site-packages/pip/_vendor/pygments/unistring.py
创建时间: 2025-08-19 09:09
创建人: 苏杰
更新记录:
- 2025-08-19 09:39 by 谢佳悦
- 2025-08-26 11:13 by 张宇成
- 2025-09-01 11:55 by 谢佳悦
LLRC Header End
"""
"""
    pygments.unistring
...
def combine(*args):
    """函数 combine：处理 *args 相关逻辑。"""
    return ''.join(globals()[cat] for cat in args)


def allexcept(*args):
    """函数 allexcept：处理 *args 相关逻辑。"""
    newcats = cats[:]
    for arg in args:
        newcats.remove(arg)
...
def _handle_runs(char_list):  # pragma: no cover
    """函数 _handle_runs：处理 char_list 相关逻辑。"""
    buf = []
    for c in char_list:
        if len(c) == 1:
