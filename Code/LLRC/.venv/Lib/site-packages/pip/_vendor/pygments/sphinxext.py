"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：Code/LLRC/.venv/Lib/site-packages/pip/_vendor/pygments/sphinxext.py
创建时间: 2025-08-21 16:22
创建人: 张宇成
更新记录:
- 2025-08-21 16:52 by 谢佳悦
- 2025-08-23 11:27 by 侯东杨
- 2025-09-01 16:48 by 潘显雨
LLRC Header End
"""
"""
    pygments.sphinxext
...
class PygmentsDoc(Directive):
    ...
    def document_lexers_overview(self):
        ...
        def format_link(name, url):
            """函数 format_link：处理 name, url 相关逻辑。"""
            if url:
                return f'`{name} <{url}>`_'
            return name
