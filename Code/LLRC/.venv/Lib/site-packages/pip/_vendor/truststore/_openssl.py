"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：Code/LLRC/.venv/Lib/site-packages/pip/_vendor/truststore/_openssl.py
创建时间: 2025-08-21 11:26
创建人: 李雨梦
更新记录:
- 2025-08-21 11:56 by 李雨梦
- 2025-08-25 10:50 by 苏杰
LLRC Header End
"""
import contextlib
import os
