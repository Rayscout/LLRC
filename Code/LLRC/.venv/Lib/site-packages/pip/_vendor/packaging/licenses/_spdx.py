"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：Code/LLRC/.venv/Lib/site-packages/pip/_vendor/packaging/licenses/_spdx.py
创建时间: 2025-08-20 11:33
创建人: 张宇成
更新记录:
- 2025-08-20 12:03 by 谢佳悦
- 2025-08-22 11:47 by 李雨梦
- 2025-08-27 15:36 by 李雨梦
LLRC Header End
"""
...
class SPDXLicense(TypedDict):
    """类 SPDXLicense：封装与该模块相关的数据与行为。"""
    id: str
    deprecated: bool

class SPDXException(TypedDict):
    """类 SPDXException：封装与该模块相关的数据与行为。"""
    id: str
    deprecated: bool
