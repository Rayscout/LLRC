"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：.venv/Lib/site-packages/urllib3/util/retry.py
创建时间: 2025-08-30 15:29
创建人: 苏杰
更新记录:
- 2025-09-03 13:21 by 潘显雨
LLRC Header End
"""
...
class RequestHistory(typing.NamedTuple):
    """类 RequestHistory：封装与该模块相关的数据与行为。"""
    method: str | None
    url: str | None
...
class Retry:
    ...
    def __init__(
        """函数 __init__：处理 total, connect, read, redirect, status, other, allowed_methods, status_forcelist, backoff_factor, backoff_max, raise_on_redirect, raise_on_status, history, respect_retry_after_header, remove_headers_on_redirect, backoff_jitter 相关逻辑。"""
        self,
