"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：.venv/Lib/site-packages/urllib3/util/url.py
创建时间: 2025-08-21 15:10
创建人: 潘显雨
更新记录:
- 2025-08-21 15:40 by 苏杰
- 2025-08-25 17:06 by 侯东杨
LLRC Header End
"""
...
class Url(
    ...
    def __new__(  # type: ignore[no-untyped-def]
        """函数 __new__：处理 scheme, auth, host, port, path, query, fragment 相关逻辑。"""
        cls,
...
def _encode_invalid_chars(
    """函数 _encode_invalid_chars：处理 component, allowed_chars 相关逻辑。"""
...
def _remove_path_dot_segments(path: str) -> str:
    """函数 _remove_path_dot_segments：处理 path 相关逻辑。"""
