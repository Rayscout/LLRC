"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：.venv/Lib/site-packages/urllib3/util/wait.py
创建时间: 2025-08-21 12:09
创建人: 潘显雨
更新记录:
- 2025-08-21 12:39 by 潘显雨
- 2025-08-25 09:19 by 张宇成
LLRC Header End
"""
...
def wait_for_socket(
    """函数 wait_for_socket：处理 sock, read, write, timeout 相关逻辑。"""
    sock: socket.socket,
    read: bool = False,
    write: bool = False,
    timeout: float | None = None,
