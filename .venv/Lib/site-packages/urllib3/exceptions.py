"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：.venv/Lib/site-packages/urllib3/exceptions.py
创建时间: 2025-08-21 12:51
创建人: 苏杰
更新记录:
- 2025-08-21 13:21 by 潘显雨
- 2025-08-22 10:18 by 侯东杨
- 2025-08-22 10:49 by 苏杰
LLRC Header End
"""
...
class PoolError(HTTPError):
    ...
    def __init__(self, pool: ConnectionPool, message: str) -> None:
        """函数 __init__：处理 pool, message 相关逻辑。"""
        self.pool = pool
...
class RequestError(PoolError):
    ...
    def __init__(self, pool: ConnectionPool, url: str, message: str) -> None:
        """函数 __init__：处理 pool, url, message 相关逻辑。"""
        self.url = url
...
class ProxyError(HTTPError):
    ...
    def __init__(self, message: str, error: Exception) -> None:
        """函数 __init__：处理 message, error 相关逻辑。"""
...
class MaxRetryError(RequestError):
    ...
    def __init__(
        """函数 __init__：处理 pool, url, reason 相关逻辑。"""
...
class HostChangedError(RequestError):
    ...
    def __init__(
        """函数 __init__：处理 pool, url, retries 相关逻辑。"""
...
class NewConnectionError(ConnectTimeoutError, HTTPError):
    ...
    def __init__(self, conn: HTTPConnection, message: str) -> None:
        """函数 __init__：处理 conn, message 相关逻辑。"""
        self.conn = conn
...
class NameResolutionError(NewConnectionError):
    ...
    def __init__(self, host: str, conn: HTTPConnection, reason: socket.gaierror):
        """函数 __init__：处理 host, conn, reason 相关逻辑。"""
...
class IncompleteRead(HTTPError, httplib_IncompleteRead):
    ...
    def __init__(self, partial: int, expected: int) -> None:
        """函数 __init__：处理 partial, expected 相关逻辑。"""
...
class InvalidChunkLength(HTTPError, httplib_IncompleteRead):
    ...
    def __init__(self, response: HTTPResponse, length: bytes) -> None:
        """函数 __init__：处理 response, length 相关逻辑。"""
...
class HeaderParsingError(HTTPError):
    ...
    def __init__(
        """函数 __init__：处理 defects, unparsed_data 相关逻辑。"""
