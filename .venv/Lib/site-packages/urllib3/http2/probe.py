"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：.venv/Lib/site-packages/urllib3/http2/probe.py
创建时间: 2025-08-30 15:29
创建人: 李雨梦
更新记录:
- 2025-09-01 15:54 by 侯东杨
- 2025-09-03 10:38 by 潘显雨
LLRC Header End
"""
...
class _HTTP2ProbeCache:
    """类 _HTTP2ProbeCache：封装与该模块相关的数据与行为。"""
    __slots__ = (
        "_lock",
        "_cache_locks",
        "_cache_values",
    ...
    def acquire_and_get(self, host: str, port: int) -> bool | None:
        """函数 acquire_and_get：处理 host, port 相关逻辑。"""
    ...
    def set_and_release(
        """函数 set_and_release：处理 host, port, supports_http2 相关逻辑。"""
