"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：.venv/Lib/site-packages/bs4/formatter.py
创建时间: 2025-08-24 10:11
创建人: 侯东杨
更新记录:
- 2025-08-24 10:41 by 李雨梦
- 2025-08-25 13:13 by 张宇成
LLRC Header End
"""
...
class Formatter(EntitySubstitution):
    ...
    def _default(
        """函数 _default：处理 language, value, kwarg 相关逻辑。"""
...
class HTMLFormatter(Formatter):
    ...
    def __init__(
        """函数 __init__：处理 entity_substitution, void_element_close_prefix, cdata_containing_tags, empty_attributes_are_booleans, indent 相关逻辑。"""
        self,
        entity_substitution: Optional[_EntitySubstitutionFunction] = None,
        void_element_close_prefix: str = "/",
        cdata_containing_tags: Optional[Set[str]] = None,
