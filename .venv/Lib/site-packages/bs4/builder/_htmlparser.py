"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：.venv/Lib/site-packages/bs4/builder/_htmlparser.py
创建时间: 2025-08-22 13:49
创建人: 潘显雨
更新记录:
- 2025-08-22 14:19 by 侯东杨
- 2025-08-26 09:07 by 张宇成
LLRC Header End
"""
# encoding: utf-8
...
class BeautifulSoupHTMLParser(HTMLParser, DetectsXMLParsedAsHTML):
    """类 BeautifulSoupHTMLParser：封装与该模块相关的数据与行为。"""
    ...
    def __init__(
        """函数 __init__：处理 soup, *args, on_duplicate_attribute, **kwargs 相关逻辑。"""
        self,
        soup: BeautifulSoup,
        *args: Any,
