"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：.venv/Lib/site-packages/pip/_vendor/pygments/formatters/img.py
创建时间: 2025-08-23 10:19
创建人: 潘显雨
更新记录:
- 2025-08-23 10:49 by 李雨梦
- 2025-08-23 17:00 by 李雨梦
- 2025-09-03 11:35 by 苏杰
LLRC Header End
"""
"""
...
class FontManager:
    ...
    def __init__(self, font_name, font_size=14):
        """函数 __init__：处理 font_name, font_size 相关逻辑。"""
    ...
    def _get_nix_font_path(self, name, style):
        """函数 _get_nix_font_path：处理 name, style 相关逻辑。"""
    ...
    def _get_mac_font_path(self, font_map, name, style):
        """函数 _get_mac_font_path：处理 font_map, name, style 相关逻辑。"""
        return font_map.get((name + ' ' + style).strip().lower())

    def _create_mac(self):
        """函数 _create_mac：核心业务逻辑。"""
        font_map = {}
    ...
    def _lookup_win(self, key, basename, styles, fail=False):
        """函数 _lookup_win：处理 key, basename, styles, fail 相关逻辑。"""
