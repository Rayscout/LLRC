"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：.venv/Lib/site-packages/pip/_internal/utils/compat.py
创建时间: 2025-08-28 09:33
创建人: 张宇成
更新记录:
- 2025-08-28 10:03 by 侯东杨
- 2025-08-28 10:26 by 侯东杨
- 2025-08-29 16:00 by 谢佳悦
LLRC Header End
"""
...
if sys.version_info < (3, 11):
    ...
    def open_text_resource(
        """函数 open_text_resource：处理 package, resource, encoding, errors 相关逻辑。"""
