"""
LLRC Header Start
文件功能: 通用 Python 脚本/模块：config/gunicorn_export_optimized.conf.py
创建时间: 2025-08-20 13:20
创建人: 张宇成
更新记录:
- 2025-08-21 13:30 by 李雨梦
- 2025-08-28 16:58 by 张宇成
- 2025-08-30 16:59 by 潘显雨
LLRC Header End
"""
"""
FILE-HEADER-AUTO-ADDED
文件: config/gunicorn_export_optimized.conf.py
功能: 通用模块
创建时间: 2025-09-03 18:38
创建人: 苏杰
更新记录:
- 2025-08-20 13:50 by 谢佳悦
- 2025-08-24 14:35 by 谢佳悦
"""
# Gunicorn配置文件 - 优化导出功能
